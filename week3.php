...
<p>Modify the code so that it is possible to switch more than one LED on, by separating the colors with a comma (','); e.g. when you want to put a red and a green LED on, you type 'red,green' in the Serial Monitor. You can make use of the method <tt>getValue(sting, seperator, index)</tt> that is provided below (<a href="files/arduino-getvalue.ino">download it here</a>; just paste that code into your Arduino IDE, below (outside of) the <tt>loop</tt>-method):</p>
...
<p class="aside"><u>IMPORANT:</u> we are going to expand on this exercise in week 4, so don't disassemble it; or at least make sure you can reproduce it without trouble.</p>
  </section><!-- exercise2 -->
  ...
  <section id="exercise3">
    ...
    <div id="toc" class="sidebar">
        ...
        <ol>
           ...
           <li><a href="#exercise3">sensing the distance</a></li>
