...
public class SendToSerialOnStart : MonoBehaviour
{
    ...
    public float speed = 0f; // we are going to change the speed with a potentialmeter
    ...
    void DataThread()
    {
        ...
        while (spManager.serialPort != null && spManager.serialPort.IsOpen)
        {
            ...
            try
            {
                ...
                int potValue = int.Parse(value); // Convert string to integer
                speed = Mathf.Lerp(0, 10, potValue / 1023f); // Scale the value to 0-10
