...
<div id="main">
  ...
  <section id="exercise2">
    ...
    <p><b>Note:</b> in order for this to work you need to close the Serial Monitor, as only one process can listen to incoming messages on a serial port at any give time. If the Serial Monitor is doing that, you cannot hav    
	<p>Check out all the different things that are happening in the scene by turning the potentiometer on your breadboard. And check out the documentation in the Docs folder.</p>
  </section>
  <!-- exercise2 -->
...
<div id="hamburger"> <img src="imgs/menu.jpeg" alt="Hamburger-menu"> </div>
<!-- hamburger -->
